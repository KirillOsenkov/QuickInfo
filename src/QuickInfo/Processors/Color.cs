    ...
    public class Color : IProcessor
    {
        ...
        private object RenderColorTable()
        {
            var swatches = new string[10, 14]
            {
                ...
                { "Khaki", "BlanchedAlmond", "Bisque", "Cornsilk", "Transparent", "OldLace", "SeaShell", "Azure", "GhostWhite", "AliceBlue", "PowderBlue", "LightSkyBlue", "DodgerBlue", "MediumBlue" },
                { "PaleGoldenrod", "Wheat", "Moccasin", "LightYellow", "PapayaWhip", "PeachPuff", "AntiqueWhite", "Linen", "LavenderBlush", "Lavender", "LightSteelBlue", "SkyBlue", "RoyalBlue", "Blue" },
                { "Yellow", "BurlyWood", "NavajoWhite", "Orange", "Coral", "DarkSalmon", "LightSalmon", "LightPink", "Pink", "MistyRose", "Thistle", "MediumSlateBlue", "SlateBlue", "DarkSlateBlue" },
                { "Gold", "Tan", "SandyBrown", "DarkOrange", "Tomato", "Salmon", "LightCoral", "RosyBrown", "Violet", "Plum", "BlueViolet", "MediumPurple", "RebeccaPurple", "DarkBlue" },
